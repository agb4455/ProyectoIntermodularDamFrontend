...
export class StatisticsComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Suscripción reactiva: se ejecuta cada vez que cambian los queryParams
    // (necesario porque Angular reutiliza el componente al navegar entre /stats y /stats?gameId=xxx)
